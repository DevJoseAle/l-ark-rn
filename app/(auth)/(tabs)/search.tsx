  ...
  const renderCampaignCard = (campaign: CampaignSearchResult) => {
    ...
    return (
      <TouchableOpacity
        ...
        activeOpacity={0.7}
      >
        {mainImage && <Image source={{ uri: mainImage }} style={styles.campaignImage} />}
        ...
        <View style={styles.campaignContent}>
          ...
          <View style={styles.statsRow}>
            <View style={styles.stat}>
              <Text style={styles.statValue}>${campaign.total_raised.toLocaleString()}</Text>
              <Text style={styles.statLabel}>recaudado</Text>
            </View>

            <View style={styles.stat}>
              <Text style={styles.statValue}>${campaign.goal_amount.toLocaleString()}</Text>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.modeSwitcher}>
              ...
              >
                ...
                />
                <Text
                  style={[styles.modeBtnText, searchMode === 'code' && styles.modeBtnTextActive]}
                >
                  Por Código
                </Text>
              </TouchableOpacity>
              ...
              >
                ...
                />
                <Text
                  style={[styles.modeBtnText, searchMode === 'text' && styles.modeBtnTextActive]}
                >
                  Por Texto
                </Text>
              </TouchableOpacity>
          ...
          <View style={styles.searchContainer}>
            <View style={styles.searchBox}>
              ...
              <TextInput
                ...
                placeholder={searchMode === 'code' ? 'Ej: abc1234' : 'Buscar por título...'}
              ...
              <>
                ...
                {featured.length === 0 && !loading && (
                  <View style={styles.emptyState}>
                    ...
                    <Text style={styles.emptyText}>Las campañas destacadas aparecerán aquí</Text>
                  </View>
                )}
              </>
            )}
...
const searchStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    safeArea: {
      flex: 1,
    },
