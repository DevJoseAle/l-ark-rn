  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        <View>
          ...
          <View style={{ flexDirection: 'row' }}>
            <Text style={styles.totalAmountCode}>{getCurrencyCode(country)}</Text>
        ...
        <TouchableOpacity style={styles.visibilityButton} onPress={handleBottomSheetOpen}>
      ...
      <View style={styles.progressSection}>
        ...
        <View style={styles.progressAmounts}>
          <Text style={styles.currentAmount}>
            {getCurrencyCode(country)}: {fromUSDNumberToCurrencyString(currentAmount, country)}
          </Text>
          <Text style={styles.goalAmount}>
            {getCurrencyCode(country)}: {fromUSDNumberToCurrencyString(goalAmount, country)}
          </Text>
        </View>
      ...
      <View style={styles.secondaryButtons}>
        ...
        <TouchableOpacity style={styles.secondaryButton} onPress={onSendLink}>
...
const cardCampaignStyles = (color: ThemeColors) =>
  StyleSheet.create({
    container: {
      borderRadius: 24,
      padding: 24,
