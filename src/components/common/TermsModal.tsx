      ...
      <View style={styles.overlay}>
        <SafeAreaView style={styles.safeArea}>
          <View style={styles.modal}>
            ...
            >
              <Text style={styles.lastUpdated}>Última actualización: 24 de Octubre, 2025</Text>

              <Text style={styles.sectionTitle}>1. Aceptación de Términos</Text>
              <Text style={styles.paragraph}>
                Al crear una cuenta en L-ark, aceptas estos Términos y Condiciones. Si no estás de
                acuerdo, no podrás usar la plataforma.
              </Text>

              <Text style={styles.sectionTitle}>2. Descripción del Servicio</Text>
              <Text style={styles.paragraph}>
                L-ark es una plataforma de herencia digital que permite crear campañas de
                recaudación de fondos que se activan automáticamente cuando se detecta la causal
                (fallecimiento o inactividad prolongada).
              </Text>
              ...
              <Text style={styles.paragraph}>
                Consulta nuestra Política de Privacidad para información sobre cómo recopilamos,
                usamos y protegemos tus datos personales.
              </Text>

              <Text style={styles.sectionTitle}>8. Limitación de Responsabilidad</Text>
              <Text style={styles.paragraph}>
                L-ark no se hace responsable por:{'\n'}• Pérdidas derivadas de información
                incorrecta proporcionada por usuarios{'\n'}• Fallos en servicios de terceros
                (Stripe, proveedores de pago){'\n'}• Acceso no autorizado a cuentas por negligencia
                del usuario
              </Text>

              <Text style={styles.sectionTitle}>9. Modificaciones</Text>
              <Text style={styles.paragraph}>
                Nos reservamos el derecho de modificar estos términos. Te notificaremos por email de
              ...
              <Text style={styles.paragraph}>
                ...
                resolverá en los tribunales de [TU CIUDAD].
              </Text>

              <Text style={styles.footer}>
                Al hacer clic en "Aceptar y Continuar", confirmas que has leído y aceptas estos
...
const termsModalStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    overlay: {
      flex: 1,
